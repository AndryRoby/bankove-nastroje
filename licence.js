// licence.js: ARLing licence verification for Bankové nástroje pre účtovníkov
// (the "sepa-pro" bundle plan: one licence unlocking Pro across all four
// bank tools: SEPA pain.001 Doctor, SEPA pain.001 Generátor, camt.053 →
// Excel, and Párovač platieb).
//
...
//
// arling.sk hosts every ARLing tool on the same origin, so localStorage
// under the STORAGE_KEY below is visible to every tool page under
// https://arling.sk/*, not only this one: buy Pro once here (or on any of
// the four tool pages, once each of them also accepts "sepa-pro": see
// sepa-pain001-generator/licence.js and camt053-to-excel/licence.js) and
// the key already works on the rest.
//
...
export const DEFAULT_PLAN = 'sepa-pro';
export const STORAGE_KEY = 'arling_licence_sepa-pro';
